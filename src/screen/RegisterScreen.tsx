...
export default function RegisterScreen() {
  ...
  async function onSubmit() {
    try {
      ...
      setError(e?.message || e?.response?.data?.message || 'Erreur d\'inscription');
    }
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={styles.cryptoSymbolText}>Nom</Text>
        <TextInput
          value={name}
      ...
      <View style={styles.section}>
        <Text style={styles.cryptoSymbolText}>Déjà un compte ?</Text>
        <TouchableOpacity onPress={() => navigation.navigate('Login')}>
          <Text style={styles.seeAllText}>Se connecter</Text>
        </TouchableOpacity>
      </View>
